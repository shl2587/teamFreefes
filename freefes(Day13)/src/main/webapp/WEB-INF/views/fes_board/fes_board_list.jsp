...
$(function (){
	$("#local_gov").val("${param.region}").attr("selected","selected")
	$("#region_section").val("${param.region_section}").attr("selected","selected")
...
document.addEventListener("DOMContentLoaded", function () {
    const initialSelectedOption = document.getElementById("local_gov").value
    updateRegionOptions(initialSelectedOption)
})

$("form").on("submit", function () {
    const selectedOption = $("#local_gov").val()
    updateRegionOptions(selectedOption)
})
