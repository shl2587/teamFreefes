	...
	<div class="main_header_left">
		<div id="homepage_logo">
			<a href="${cpath }"><input type="image" 
				src="${cpath }/resources/image/로고.png" height="120px" 
...
<main>
		...
		<c:set var="imges" value="${fn:split(filePath, '&') }"/>
            <div class="slide ${status.index == 0 ? 'active' : 'hidden' }" >
               <a href="${cpath }/fes_board/mainboard/${dto.idx}">
                  <img class="image" src="${cpath }/upload/${dto.title }/${imges[0]}">
               </a>
					<!-- 개최중인지 상태 -->
	...
	<div class="map">
		<div class="map_inner">
			<a class="map_atag" href="${cpath }/fes_board/fes_board_list?region=강원">
            	<img src="${cpath}/resources/img/강원도.png" style="z-index: 1;">
        	</a>
        	<a class="map_atag" href="${cpath }/fes_board/fes_board_list?region=경기도">
				<img src="${cpath }/resources/img/경기도.png" style="z-index: 1;">
			</a>
			<a class="map_atag" href="${cpath }/fes_board/fes_board_list?region=서울">
				<img src="${cpath }/resources/img/서울.png" style="z-index: 2; width: 3.8%; height: auto;">
			</a>
			<a class="map_atag" href="${cpath }/fes_board/fes_board_list?region=충청북도">
				<img src="${cpath }/resources/img/충청북도.png" style="z-index: 2;">
			</a>
			<a class="map_atag" href="${cpath }/fes_board/fes_board_list?region=충청남도">
				<img src="${cpath }/resources/img/충청남도.png" style="z-index: 1; width: 13%; height: auto;">
			</a>
			<a class="map_atag" href="${cpath }/fes_board/fes_board_list?region=대전">
				<img src="${cpath }/resources/img/대전.png" style="z-index: 3; width: 3%; height: auto;">
			</a>
			<a class="map_atag" href="${cpath }/fes_board/fes_board_list?region=경상북도">
				<img src="${cpath }/resources/img/경상북도.png" style="z-index: 1; width: 13%; height: auto;">
			</a>
			<a class="map_atag" href="${cpath }/fes_board/fes_board_list?region=대구">
				<img src="${cpath }/resources/img/대구.png" style="z-index: 2; width: 5.4%; height: auto;">
			</a>
			<a class="map_atag" href="${cpath }/fes_board/fes_board_list?region=경상남도">
				<img src="${cpath }/resources/img/경상남도.png" style="z-index: 1; width: 15%; height: auto;">
			</a>
			<a class="map_atag" href="${cpath }/fes_board/fes_board_list?region=전라남도">
				<img src="${cpath }/resources/img/전라북도.png" style="width: 15%; height: auto;">
			</a>
			<a class="map_atag" href="${cpath }/fes_board/fes_board_list?region=울산">
				<img src="${cpath }/resources/img/울산.png" style="z-index: 2;width: 7%; height: auto;">
			</a>
			<a class="map_atag" href="${cpath }/fes_board/fes_board_list?region=부산">
			...
			<a class="map_atag" href="${cpath }/fes_board/fes_board_list?region=광주">
				<img src="${cpath }/resources/img/광주.png" style="z-index: 4;width: 4%; height: auto;">
			</a>
			<a class="map_atag" href="${cpath }/fes_board/fes_board_list?region=제주도">
		...
		<div class="boards_summary_in">
			<div class="main_body3">
				...
				<div class="recent_notice_list">
					<c:forEach var="notice" items="${notice_list }" begin="1" end="5" >
					<div class="recent_notice_content">
						<div class="notice_title_length"><a href="${cpath }/admin_board/admin_view/${notice.idx}">${notice.title }</a></div>
						<div><fmt:formatDate value="${notice.write_date }" pattern="MM-dd" /></div>
					</div>
					</c:forEach>
				</div>
				</div>
			...
			<div class="main_body4">
				<div class="rank_summary">축제 순위</div>
