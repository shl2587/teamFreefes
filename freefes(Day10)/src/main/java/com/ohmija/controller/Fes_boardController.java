...
public class Fes_boardController {
	...
	@GetMapping("/fes_board_l;st")
	public ModelAndView main_board(@RequestParam(value="request_page", defaultValue="1") int request_page, 
									Fes_searchDTO dto) {
		ModelAndView mav = new ModelAndView();
		// 페이징 코드
		System.out.println("현재 페이지 : " + request_page);
