	...
	<table class="management_message_table">
	  <thead>
	    <tr>
			...
			<th>Category</th>
			<th>Date</th>
	     	<th><input type="checkbox" class="message-all-delete" data-idx="${dto.idx}"></th>
	    </tr>
	  </thead>
	  <tbody>
	    <c:forEach var="dto" items="${list}">
	      <tr>
	        ...
	        <td><input type="checkbox" class="message-delete" data-idx="${dto.idx}"></td>
	      </tr>
	    </c:forEach>
	  </tbody>
	</table>
...
<div class="delete_btn">
	<button type="button" class="message-delete-button"  data-idx="${dto.idx}">
