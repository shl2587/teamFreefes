...
<%
    ...
    if (jsonData != null && !jsonData.isEmpty()) {
        ...
        JSONArray boardList = jsonObject.getJSONArray("fes_boardList");
        JSONArray fes_paging_dto = jsonObject.getJSONArray("fes_paging_dto");

        request.setAttribute("boardList", boardList);
        System.out.println(boardList.toString());
        request.setAttribute("fes_paging_dto", fes_paging_dto);
    }
%>
