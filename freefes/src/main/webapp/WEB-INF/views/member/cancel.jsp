...
button#log_bye:hover {
    background-color: #0056b3;
}

input[type="checkbox"].checkbox_cencel_check {
    margin-right: 10px;
}
    
</style>
<h1 class="cancel_title">탈퇴 안내</h1>
<pre class="member_bye_cencel">
...
<p class="cancel_check_box"><input class="checkbox_cencel_check" type="checkbox" name="log_bye_check">동의를 한다면 체크해주세요</p>
