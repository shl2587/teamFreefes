...
<%@include file="mypage/mypage.jsp" %>
    <style>
        ...
        button#submitButton_bye:hover {
            background-color: #0056b3;
        }

    </style>
<h1 class="member_bye_title">회원 탈퇴 확인</h1>
<form id="log_bye_user">
   <p><input type="text" class="member_bye_userid" name="userid" placeholder="ID" value="${login.userid }" autofocus></p>
   <p><input type="password" name="userpw" placeholder="Password" required></p>
   <button id="submitButton_bye">회원탈퇴</button>
</form>
