...
<div class="management_main_flex">
	<div class="management_title">
		<h3 style="color: #F0B86E; font-size:23px;">Management /
			<span style="color: #FF6969; font-size:27px;">Notice-Amend</span>
		</h3>
	</div>
...
<div class="management_notice_write_form">
	<form method="POST"> 
		<div>
			...
			<input type="text" id="m_title" name="title" value="${dto.title }" required autofocus>
		...
		<div>
			...
			<textarea id="m_content" name="content" required>${dto.content }</textarea>
		</div>
		<div class="notice_write_btn"><button type="submit">수정 완료</button></div>
	</form>
</div>
